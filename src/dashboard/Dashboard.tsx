import {  Avatar, Button, Col, Layout, Row, Space,Calendar, theme, Select  } from "antd";
...
import PieChartNL from "./PieChartLN";
...
<g id="monitor">
<path id="Vector" d="M3.75663 1.16699H10.2375C12.3141 1.16699 12.8333 1.68616 12.8333 3.75699V7.44949C12.8333 9.52616 12.3141 10.0395 10.2433 10.0395H3.75663C1.68579 10.0453 1.16663 9.52616 1.16663 7.45533V3.75699C1.16663 1.68616 1.68579 1.16699 3.75663 1.16699Z" stroke="#FF7506" stroke-linecap="round" stroke-linejoin="round"/>
<path id="Vector_2" d="M7 10.0449V12.8333" stroke="#FF7506" stroke-linecap="round" stroke-linejoin="round"/>
<path id="Vector_3" d="M1.16663 7.58301H12.8333" stroke="#FF7506" stroke-linecap="round" stroke-linejoin="round"/>
<path id="Vector_4" d="M4.375 12.833H9.625" stroke="#FF7506" stroke-linecap="round" stroke-linejoin="round"/>
</g>
</g>
</svg>
  );
  const Monitor2= () => (
    ...
    <g id="Group 304">
    <path id="Vector" d="M14.7704 5.7304C14.7704 7.04284 14.0591 8.22267 12.9266 9.04368C12.8874 9.07098 12.8658 9.11778 12.8639 9.16459L12.8149 10.4419C12.809 10.6135 12.6189 10.713 12.4739 10.6213L11.3864 9.94074C11.3864 9.94074 11.3864 9.94074 11.3845 9.94074C11.3218 9.89978 11.2453 9.88808 11.1748 9.90954C10.5282 10.1104 9.82472 10.2216 9.08797 10.2216C9.07817 10.2216 9.06837 10.2216 9.05857 10.2216C9.07817 10.0928 9.08797 9.96219 9.08797 9.82958C9.08797 7.99841 7.2108 6.51436 4.89472 6.51436C4.41857 6.51436 3.96201 6.57676 3.53485 6.69182C3.44863 6.38175 3.40356 6.05802 3.40356 5.7265C3.40356 3.24398 5.94695 1.2334 9.08601 1.2334C12.227 1.2373 14.7704 3.24983 14.7704 5.7304Z" stroke="#4277FF" stroke-width="1.10526" stroke-miterlimit="10"/>
    <path id="Vector_2" d="M3.53675 6.69531C1.88884 7.14189 0.703369 8.37828 0.703369 9.83308C0.703369 10.8003 1.22851 11.6721 2.06324 12.2785C2.09263 12.3 2.1083 12.3331 2.11026 12.3682L2.14553 13.3102C2.14945 13.4369 2.29053 13.5091 2.3983 13.4428L3.20168 12.9396C3.20756 12.9357 3.2154 12.9299 3.22128 12.926C3.25067 12.9026 3.28986 12.8948 3.32513 12.9065C3.81108 13.0625 4.34013 13.1483 4.89662 13.1483C7.04419 13.1483 8.81555 11.871 9.06048 10.2251" stroke="#4277FF" stroke-width="1.10526" stroke-miterlimit="10"/>
    </g>
    </svg>
  ...
  const Monitor3= () => (
<svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
<g id="fi:layers" clip-path="url(#clip0_201_18603)">
<path id="Vector" d="M1.16663 9.91699L6.99996 12.8337L12.8333 9.91699" stroke="#35C75A" stroke-width="1.16667" stroke-linecap="round" stroke-linejoin="round"/>
<path id="Vector_2" d="M1.16663 7L6.99996 9.91667L12.8333 7" stroke="#35C75A" stroke-width="1.16667" stroke-linecap="round" stroke-linejoin="round"/>
<path id="Vector_3" d="M6.99996 1.16699L1.16663 4.08366L6.99996 7.00033L12.8333 4.08366L6.99996 1.16699Z" stroke="#35C75A" stroke-width="1.16667" stroke-linecap="round" stroke-linejoin="round"/>
</g>
<defs>
...
const Dashboard: React.FC = () => {
  ...
  return (
    ...
    <Layout>
      ...
      <Layout>
       <Row>
        <Col style={{paddingLeft:'50px'}} span={16}>
            <Row>
                <Col className="h1_D" span={24}>
                Dashboard
                </Col>
            </Row>
            <Row>   
                <Col className="h1_D2" span={24}>
                Biểu đồ cấp số
                </Col>
            </Row>
            <Row>
                <Col className="B-Icon" span={5}>
                        <div className="B-Da">
                        <Row>
                        <Col span={8}>
                            <Space className="D-icon"><Group1  /></Space>
                            
                        </Col>
                        <Col className="text-D" span={16}>
                            <span>Số thứ tự <br /> đã cấp</span>
                        </Col>
                    </Row>
                    <Row>
                        <Col className="num-D" span={12}>
                        4.221
                        </Col>
                        <Col span={12}>
                            <span></span>
                ...
                <Col className="B-Icon" span={5}>
                        ...
                        <Row>
                        <Col span={8}>
                            <Space className="D-icon2"><Group2  /></Space>
                            
                        </Col>
                        <Col className="text-D" span={16}>
                            <span>Số thứ tự <br />đã sử dụng</span>
                        </Col>
                    </Row>
                    <Row>
                        <Col className="num-D" span={12}>
                ...
                <Col className="B-Icon" span={5}>
                        ...
                        <Row>
                        <Col span={8}>
                            <Space className="D-icon3"><Group3  /></Space>
                            
                        </Col>
                        <Col className="text-D" span={16}>
                            <span>Số thứ tự <br />đang chờ</span>
                        </Col>
                    </Row>
                    <Row>
                        <Col className="num-D" span={12}>
                ...
                <Col className="B-Icon" span={5}>
                        ...
                        <Row>
                        <Col span={8}>
                            <Space className="D-icon4"><Group4  /></Space>
                            
                        </Col>
                        <Col className="text-D" span={16}>
                            <span>Số thứ tự <br />đã bỏ qua</span>
                        </Col>
                    </Row>
                    <Row>
                        <Col className="num-D" span={12}>
            ...
            <br />
            <Row>
                <Col style={{background:'white'}} span={23}>
                    <Row>
                        <Col span={18}>
                        <span className="text-D1">Bảng thống kê theo ngày</span> 
                        </Col>
                        <Col span={3}>
                        <span className="text-D2">Xem theo </span> 
                        </Col>
                        <Col span={3}>
                        <Select
              className="col-inputD1"
              value={"Tháng"}
            >
              ...
              <Option value="Tháng">Tháng</Option>
                    ...
                    <Row>
                        <Col span={24}>
                        <span className="text-D3">Tháng 11/2021 </span> 
        ...
        <Col className="D-2" span={8}>
            <Row>
                <Col style={{paddingLeft:'200px'}} span={24}>
        ...
        {showNotification && (
          <div className="notification-container">
            ...
            <Row>
                <Col span={24}>
                <span className="text-D2">Tổng quan</span>
                </Col>
            </Row>
            <br />
            <Row>
                <Col className="B-da1" span={22}>
                
                    <Row>
                        <Col className="pieChartE" span={10}>
                        <PieChartE />
                        </Col>
                        <Col span={14}>
                            <br />
                            <Row>
                                <Col className="text-Da1" span={12}>
                                4.221
                                </Col>
                                
                                <Col span={12}>
                                    <span className="text-Db2">Đang hoạt động</span>
                                
                                </Col>
                            </Row>
                            <Row>
                                <Col  span={12}>
                                <Monitor1 /> <span style={{color:'#FF7506'}}>Thiết bị</span>   </Col>
                                <Col span={12}>
                                    <span className="text-Db2">Ngưng hoạt động</span>
                ...
                <Col className="B-da1" span={22}>
                    ...
                    <Row>
                        ...
                        <Col span={14}>
                            ...
                            <Row>
                                <Col span={12}>
                                <Monitor2 /> <span style={{color:'#4277FF'}}>Dịch vụ</span>
                                </Col>
                                <Col span={12}>
                                    <span className="text-Db2">Ngưng hoạt động</span>
                    ...
                    <Row>
                        ...
                        <Col span={14}>
                            ...
                            <Row>
                                ...
                                <Col span={12}>
                                <span className="text-Db2">Đã sử dụng</span>
                                </Col>
                            </Row>
                            <Row>
                                <Col span={12}>
                                <Monitor3 /> <span style={{color:'#35C75A'}}>Cấp số</span> 
                                </Col>
                                <Col span={12}>
                                <span className="text-Db2">Đang chờ</span>
                                </Col>
                            </Row>
                            <Row>
                                <Col span={12}>
                                ...
                                <Col span={12}>
                                    <span className="text-Db2">Bỏ qua</span>
